package com.example.kyle.kylewf
 ...
 */
class KyleWatchFace : CanvasWatchFaceService() {
    ...
    private class EngineHandler(reference: KyleWatchFace.Engine) : Handler() {
        private val mWeakReference: WeakReference<KyleWatchFace.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(WatchFaceStyle.Builder(this@KyleWatchFace)
                    .setAcceptsTapEvents(true)
                    .build())

            mCalendar = Calendar.getInstance()

            val resources = this@KyleWatchFace.resources
        ...
        private fun registerReceiver() {
            ...
            this@KyleWatchFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@KyleWatchFace.unregisterReceiver(mTimeZoneReceiver)
        }
